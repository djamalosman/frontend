                            ...
                            <div class="block-banner">
                                ...
                                <div class="form-find mt-60 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                                    <form method="GET" action="{{route('job-list')}}">
                                        <input type="text" class="form-input input-keysearch mr-10" name="jobtitle" placeholder="Job title, Company... " />
        ...
        <section class="section-box" hidden>
            <div class="container">
                <div class="row align-items-end">
                    <div class="col-lg-7">
                        <h2 class="section-title mb-20 wow animate__animated animate__fadeInUp">Upcoming Browse Training By Category</h2>
            ...
            <div class="container">
                <div class="row align-items-end">
                    <div class="col-lg-6">
                        ...
                        <p class="text-md-lh28 color-black-5wow animate__animated animate__fadeInUp" data-wow-delay=".1s">6 new
                            opportunities posted today!</p>
                    </div>
                    <div class="col-lg-6 col-md-5 text-lg-end text-start">
                        <a href="{{route('course-grid')}}" class="btn btn-border icon-chevron-right wow animate__animated animate__fadeInUp hover-up mt-15" data-wow-delay=".1s">View more</a>
                    </div>
                </div>
                <div class="mt-70">
        ...
        <section class="section-box mt-40">
            <div class="container">
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-6 col-md-5 text-lg-end text-start">
                        <a href="{{route('job-grid')}}" class="btn btn-border icon-chevron-right wow animate__animated animate__fadeInUp hover-up mt-15" data-wow-delay=".1s">View more</a>
                    </div>
                </div>
                <div class="mt-70">
                    <div class="tab-content" id="myTabContent-1">
            ...
            <div class="container">
                <div class="row align-items-end">
                    ...
                    <div class="col-lg-5 col-md-5 text-lg-end text-start">
                        <a href="{{route('news-list')}}" class="btn btn-border icon-chevron-right wow animate__animated animate__fadeInUp hover-up mt-15" data-wow-delay=".1s">View more</a>
                    </div>
                </div>
                <div class="row mt-70">
                    <div class="box-swiper">
                                        ...
                                        <div class="card-grid-3 hover-up">
                                            ...
                                            <div class="text-center card-grid-3-image">
                                                <a href="/detail-news/{{base64_encode($item->id)}}">
                                                    ...
                                                    <figure><img class="imgGrid" src="{{ asset('http://127.0.0.1:8081/storage/' . ($item->file ?? '')) }}" /></figure>
                                                    </div>
                                                </a>
                                            </div>
